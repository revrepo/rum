...
Logger.prototype.log = function (level) {
  ...
  self.levels=config.syslog.levels;

  //console.log("LOG LEVELS",self.levels);
  ...
  function emit(name, next) {
   ...
   // console.log("self.levels",self.levels);
    //console.log("self.levels",self.levels);

    //console.log("transport",transport.level,"TR LEVELS",self.levels[transport.level],"SS",self.levels[level]);
...
Logger.prototype.cli = function () {
  ...
  if (this.transports.console) {
    this.transports.console.colorize = false;
